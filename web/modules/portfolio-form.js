...
export function redemptionPayload(position) {
  return { account_id: position.account_id, currency: position.currency, asset_type: position.asset_type, asset_identifier: position.asset_identifier || "", asset_name: position.asset_name || "", cnpj: position.cnpj || "", quantity: position.redemption_quantity || position.quantity || 0, current_value: position.current_value, redemption_unit_price: position.redemption_unit_price };
}
