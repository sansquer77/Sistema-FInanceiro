...
export const INSTRUCTIONS_CONTENT = [
  ...
  },
  {
    ...
    topics: [
      ...
      {
        id: "consultor",
        title: "Como usar a aba Consultor",
  ...
  },
  {
    ...
    topics: [
      ...
      {
        id: "configurar-ia",
        title: "Configurar IA e Consultor",
        summary: "A IA é opcional, reescreve Tendências e habilita o Consultor quando autorizado.",
        content: [
          "Em Usuário > Preferências > APIs, a seção Inteligência Artificial permite ligar um provedor externo para reescrever o resumo da aba Tendências e habilitar o Consultor.",
          "A análise numérica de Tendências continua sendo feita localmente. Se a IA estiver desligada ou falhar, Tendências mantém o resumo local automático.",
          "Para usar o Consultor, além da IA ligada, ative a opção do Consultor, escolha o perfil de investidor e confirme o consentimento de uso dos dados financeiros do app. O Perfil Complementar é opcional e fica criptografado.",
          "Ao desligar o Consultor ou a IA, o app avisa quando houver perda de histórico. Esta limpeza existe para garantir que análises geradas com dados enviados à IA não continuem guardadas após a autorização ser removida.",
        ],
        searchTerms: ["IA", "inteligência artificial", "tendências", "resumo", "OpenAI", "Groq", "Consultor", "perfil de investidor"],
        relatedModule: "Preferências",
        route: "user",
