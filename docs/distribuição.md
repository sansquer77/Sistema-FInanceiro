...
| `Sistema Financeiro - Distribuicao/Linux/Linux Ubuntu - X.Y.Z.zip` | arquivo zip | Zip final do Linux Ubuntu, gerado a partir de `Sistema Financeiro - Distribuicao/Linux/`, onde `X.Y.Z` vem de `financeiro/app_metadata.py`. |
