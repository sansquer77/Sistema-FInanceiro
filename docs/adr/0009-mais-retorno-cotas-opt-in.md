...
- Dias sem cota publicada (fim de semana/feriado): a data atual retorna lista vazia e a consulta é refeita com janela retroativa de 7 dias, usando a última cota publicada.
...
- `1.2` — 2026-08-08 — Fallback para dias sem cota publicada: janela retroativa de 7 dias quando a data atual retorna lista vazia.
