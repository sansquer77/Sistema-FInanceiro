...
- O tópico de **Cockpit** deve explicar o uso da aba **Consultor**: seletor fechado de análise e botão **Gerar**, ausência de prompt livre, seletor de período em "Ralos Financeiros", histórico em subaba própria e expurgo do histórico quando IA/Consultor/consentimento forem desligados.
...
- Dado um usuário lendo o tópico de Consultor, quando acessa Preferências e Cockpit, então entende como ativar o módulo, consentir o uso de dados, escolher uma análise no seletor, gerar o relatório, consultar histórico e desligar sabendo que o histórico será apagado.
